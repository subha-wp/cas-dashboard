...
import { HomeIcon, CreditCardIcon, UserIcon, LogOut } from "lucide-react";
...
export default function AgentLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: "Households", href: "/agent/households", icon: HomeIcon },
    { name: "Cards", href: "/agent/cards", icon: CreditCardIcon },
  ];
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="hidden md:flex md:w-64 md:flex-col">
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto bg-primary-foreground border-r">
          <div className="flex items-center flex-shrink-0 px-4 mb-5">
            <span className="text-xl font-bold">Health Card Agent</span>
          </div>
          ...
          <div className="flex flex-shrink-0 p-4 border-t">
            <div className="flex items-center w-full">
              ...
              <div className="ml-3 w-full">
                ...
                <p className="text-xs text-muted-foreground">Office Agent</p>
                <Button 
                  variant="link" 
                  size="sm" 
      ...
      <div className="md:hidden bg-primary text-primary-foreground py-2 px-4 flex items-center justify-between">
        <span className="text-lg font-bold">Health Card Agent</span>
        <Button 
          variant="ghost" 
          size="sm" 
