...
import { HomeIcon, SearchIcon, UserIcon, LogOut } from "lucide-react";
...
export default function HospitalLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: "Verify Card", href: "/hospital/verify", icon: SearchIcon },
  ];
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="hidden md:flex md:w-64 md:flex-col">
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto bg-primary-foreground border-r">
          <div className="flex items-center flex-shrink-0 px-4 mb-5">
            <span className="text-xl font-bold">Health Card Verification</span>
          </div>
          ...
          <div className="flex flex-shrink-0 p-4 border-t">
            <div className="flex items-center w-full">
              ...
              <div className="ml-3 w-full">
                ...
                <p className="text-xs text-muted-foreground">Hospital User</p>
                <Button 
                  variant="link" 
                  size="sm" 
      ...
      <div className="md:hidden bg-primary text-primary-foreground py-2 px-4 flex items-center justify-between">
        <span className="text-lg font-bold">Health Card Verify</span>
        <Button 
          variant="ghost" 
          size="sm" 
